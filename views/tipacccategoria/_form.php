...
<div class="peli-agen-categoria-form">
    ...
    <?= $form->field($model, 'parent_id')->dropDownList(
        ArrayHelper::map(TipAccCategoria::find()->where(['parent_id' => null])->all(), 'id', 'name'),
    ...
    <div id="greatgrandchild-container" style="display:none;">
        ...
        <button type="button" class="btn btn-primary btn-show-next" data-target="grandchild">Buscar</button>
    </div>
...
$('#search-child').click(function() {
    ...
    $.get('/tipacccategoria/get-items', { parent_id: childId }, function(data) {

...
<div class="sujeto-afectacion-index">
    ...
    <p>
        <?= Html::a('Crear Ambiente', ['create-ambiente'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, SujetoAfectacion $model, $key, $index, $column) {
                    if ($action === 'update') {
                    return Url::toRoute(['update-ambiente', 'id' => $model->id_sujeto_afect]);
                    }elseif ($action === 'delete') {
                    return Url::toRoute(['delete-ambiente', 'id' => $model->id_sujeto_afect]);
                    }

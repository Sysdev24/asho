...
<div class="sujeto-afectacion-index">
    ...
    <p>
        <?= Html::a('Crear Bienes', ['create-bienes'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, SujetoAfectacion $model, $key, $index, $column) {
                    if ($action === 'update') {
                    return Url::toRoute(['update-bienes', 'id' => $model->id_sujeto_afect]);
                    }elseif ($action === 'delete') {
                    return Url::toRoute(['delete-bienes', 'id' => $model->id_sujeto_afect]);
                    }

...
<div class="sujeto-afectacion-index">
    ...
    <p>
        <?= Html::a('Crear Procesos', ['create-procesos'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, SujetoAfectacion $model, $key, $index, $column) {
                    if ($action === 'update') {
                    return Url::toRoute(['update-procesos', 'id' => $model->id_sujeto_afect]);
                    }elseif ($action === 'delete') {
                    return Url::toRoute(['delete-procesos', 'id' => $model->id_sujeto_afect]);
                    }

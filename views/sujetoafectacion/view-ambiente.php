...
<div class="sujeto-afectacion-view">
    ...
    <p>
        <?= Html::a('Actualizar', ['update-ambiente', 'id_sujeto_afect' => $model->id_sujeto_afect], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Eliminar', ['delete-ambiente', 'id_sujeto_afect' => $model->id_sujeto_afect], [

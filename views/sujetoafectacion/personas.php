...
<div class="sujeto-afectacion-index">
    ...
    <p>
        <?= Html::a('Crear Personas', ['create-personas'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, SujetoAfectacion $model, $key, $index, $column) {
                    if ($action === 'update') {
                    return Url::toRoute(['update-personas', 'id' => $model->id_sujeto_afect]);
                    }elseif ($action === 'delete') {
                    return Url::toRoute(['delete-personas', 'id' => $model->id_sujeto_afect]);
                    }

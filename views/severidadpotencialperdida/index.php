            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model, $key) {
                        $url = ['view', 'id_sev_pot_per'=>$model->id_sev_pot_per];
                        ...
                        return \Yii::$app->user->can('severidadpotencialperdida/index') ? $link : '';
                    },
                    'update' => function ($url, $model, $key) {
                        $url = ['update', 'id_sev_pot_per'=>$model->id_sev_pot_per];
                        ...
                        return  \Yii::$app->user->can('severidadpotencialperdida/update') ? $link : '';
                    },
                    'delete' => function ($url, $model, $key) {
                        $url = ['delete', 'id_sev_pot_per'=>$model->id_sev_pot_per];
                        ...
                        return \Yii::$app->user->can('severidadpotencialperdida/delete') ? $link : '';
                    },
                ],
            ],

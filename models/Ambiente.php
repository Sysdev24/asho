...
class Ambiente extends SujetoAfectacion
{
    ...
    {
        return [
            [['id_con_afectacion'], 'default', 'value' => 4],
    ...
    {
        $model = self::findBySql('SELECT * FROM sujeto_afectacion_hijo(:suj_afec, :descripcion)', [':suj_afec' => 4, ':descripcion' => $this->descripcion])->one();

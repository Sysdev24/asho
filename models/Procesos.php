...
class Procesos extends SujetoAfectacion
{
    ...
    {
        return [
            [['id_con_afectacion'], 'default', 'value' => 3],
    ...
    {
        $model = self::findBySql('SELECT * FROM sujeto_afectacion_hijo(:suj_afec, :descripcion)', [':suj_afec' => 3, ':descripcion' => $this->descripcion])->one();

...
/**
 * SeveridadpotencialperdidaSearch represents the model behind the search form of `app\models\SeveridadPotencialPerdida`.
 */
class SeveridadpotencialperdidaSearch extends SeveridadPotencialPerdida
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_sev_pot_per', 'id_eva_pot_per', 'id_estatus'], 'integer'],
    ...
    {
        $query = SeveridadPotencialPerdida::find();
        ...
        $query->andFilterWhere([
            'id_sev_pot_per' => $this->id_sev_pot_per,

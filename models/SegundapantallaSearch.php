...
/**
 * SegundapantallaSearch represents the model behind the search form of `app\models\SegundaPantalla`.
 */
class SegundapantallaSearch extends SegundaPantalla
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere([
            ...
            'orden_persona' => $this->orden_persona,
        ]);

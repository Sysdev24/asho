...
class Personas extends SujetoAfectacion
{
    ...
    {
        return [
            [['id_con_afectacion'], 'default', 'value' => 1],
    ...
    {
        $model = self::findBySql('SELECT * FROM sujeto_afectacion_hijo(:suj_afec, :descripcion)', [':suj_afec' => 1, ':descripcion' => $this->descripcion])->one();

...
/**
 * NaturalezaaccidenteSearch represents the model behind the search form of `app\models\NaturalezaAccidente`.
 */
class NaturalezaaccidenteSearch extends NaturalezaAccidente
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_naturaleza_accidente', 'id_estatus'], 'integer'],
    ...
    {
        $query = NaturalezaAccidente::find();
